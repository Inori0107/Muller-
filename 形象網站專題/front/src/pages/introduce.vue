  ...
  <v-main id="bg">
    ...
    <v-sheet class="pt-16">
      <v-container>
        ...
        <v-img class="my-8" src="../assets/about/about.jpeg"></v-img>
        <h3 class="my-4">
          木樓合唱團在藝術總監暨指揮彭孟賢的帶領下，專注於呈現精緻合唱藝術。近年除了在國際賽事屢獲首獎外，也數次受到國際邀演舉行巡迴音樂會，木樓的足跡來到世界各地，累積了數十場音樂會，用一場場的演出，讓全世界聽到臺灣。在未來，木樓將飛往更多國家與土地，傳遞更多精緻樂音；在臺灣，以溫暖的歌聲讚頌寶島的美，延續良善，讓愛扎根。
        </h3>
      </v-container>
    </v-sheet>
    <!-- Choir -->
    <div class="bg pa-8">
      <v-container>
        <v-img src="../assets/about/choir.png" class="heroPic">
              ...
              <template #content>
                <v-timeline align="start" side="end">
                  <v-timeline-item
                    ...
                    size="small"
                  >
                    <v-card :class="['timeline-card', getClass(year.category)]">
      ...
      <v-container class="my-8">
        <v-row class="text-bg">
          ...
          >
          <v-col cols="6">
            <v-img src="../assets/about/conductor.png" rounded></v-img>
          </v-col>
        </v-row>
      </v-container>
      <!-- Pianist -->
        ...
        <v-row class="text-bg">
          ...
          <v-col cols="6" class="text-center align-content-center"
            ...
            <DialogComponent title="鋼琴　王乃加">
              <template #content>
                自3歲開始學習鋼琴。師事謝秋月、林得恩、徐頌仁、諸大明等教授。曾受鋼琴家史蘭倩絲卡讚譽「擁有驚人的視譜能力，是位不可多得的伴奏家」。美國新英格蘭音樂院教授派翠希亞．桑德讚賞「其演奏令人印象深刻，是位有潛力、天賦異稟的鋼琴家」。現任教於多所音樂班，以及擔任台北愛樂歌劇坊、台北室內合唱團、木樓合唱團鋼琴合作。亦擁有個人專屬頻道，定期發表編創作品。
                　　近年來活躍於樂壇，累積豐富的演出經歷，多次受邀於巴赫音樂節、國際合唱音樂節演出。與台北愛樂歌劇坊演出《費加洛婚禮》、《法斯塔夫》、《喬凡尼先生》、《塞維爾的理髮師》、《愛情靈藥》、《弄臣》等多部歌劇，並演出近四十場《甘泉藝文沙龍音樂會》。與台北室內合唱團錄製〈大地之歌〉、〈謠唱島嶼〉、〈聽你．聽我〉、〈當代狂潮〉專輯，入圍及榮獲金曲獎。與木樓合唱團錄製〈文學與音樂的對話〉、〈木色Ⅱ〉、〈吹動島嶼的風〉〈木色Ⅲ愛的禮讚〉專輯。與天作之合劇團演出創團劇《天堂邊緣》。
                　　2019年11月與台北室內合唱團赴海南島演出。2017年9月與台北室內合唱團赴上海現代音樂節演出。3月和大提琴家張正傑赴印度演出。2015年與台北室內合唱團於香港演出。2012年與台北愛樂室內合唱團受邀至北京及西安等地演出。2009與台北室內合唱團於香港、日本演出。2007年受邀於湖南大學演出鋼琴獨奏。2001年入圍華信愛樂鋼琴菁英獎，接受古典愛樂電臺專訪。
              </template></DialogComponent
            ></v-col
          >
        </v-row>
...
const getClass = (category) => {
  switch (category) {
    case "years":
      return "years-style";
    case "years_10":
      return "years_10-style";
    case "years_20":
      return "years_20-style";
    default:
      return "";
  }
};
...
.text-overlay {
  ...
  color: white; /* 文字顏色 */
  text-shadow: 1px 1px 2px black; /* 文字陰影，讓文字更清晰 */
}
